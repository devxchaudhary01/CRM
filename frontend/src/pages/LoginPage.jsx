...
export default function LoginPage() {
  ...
  const sendOtp = () => {
    ...
    toast('OTP login is Phase 2 — demo mode 🚧', {
      icon: 'ℹ️',
    })
  }
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        {tab === 'otp' && (
          <div>
            ...
            <div
              ...
              style={{ marginTop: 10 }}
            >
              <strong>Coming in Phase 2</strong> — SMS OTP via
              Twilio/MSG91
            </div>
          </div>
        )}
        ...
        <div
          ...
          style={{ marginTop: 10 }}
        >
          <strong>C1/C2/C3 agents:</strong> You'll land on
          Leads (no dashboard).
          <br />

          <strong>Ops Lead:</strong> Dashboard view only, no
          downloads.
        </div>
      </div>
    </div>
